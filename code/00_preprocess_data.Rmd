...
## Sensitivity data Acquisition

> Sensitivity data comes from Connnor Quiroz' first chapter on calculating global marine capture aquatic animal protein reliance.

**Note:** Based on how this script is executed, one of the two aa_reliance will be used. The first one acquires the first aquatic animal reliance for a countries' entire marine capture consumption. The second aa_reliance is only the aquatic animal reliance for countries' foreign marine capture consumption. 
...
## Adaptive capacity data acquisition
