...
# How does the rank order change for adaptive capacity
...
# Save plot
ggsave("../images/fig_one.jpg", plot = risk_map, device = "jpeg", width = 4, height = 3, units = "in")
...
fig_two <- plot_grid(comb_1, comb_2, ncol = 1)

# Save plot
ggsave("../images/fig_two.jpg", plot = fig_two, device = "jpeg", width = 6, height = 4, units = "in")
```
