...
for (i in ac_components$ac_component) {# iterate through each component
  ...
  for (j in 1:num_vars) { # Iterate through each variable
    ...
    if ((modifier + 50) / ((modifier + 50)+ (50 * (num_vars - 1))) > 0.90) {
      print(paste0("########## Variable: ", ac_variables[ac_variables$ac_component == i,]$ac_variable[j],
             " is not sensitive to any variable change ##########"))
    }

    if (pval < 0.05) {
      print("---")
      print(paste0("Variable: ", ac_variables[ac_variables$ac_component == i,]$ac_variable[j],
             " was sensitive with the following parameters:"))
      print(paste0("Dirchlet concentration paramters: "))
      print(concentration)
      print(paste0("Dirchlet proportions:"))
...
,
          ...
          # flexibility
          i == "flexilbity" & 
          ac_variable == "supermarkets_scaled" ~ value * concentration[which(ac_variables[ac_variables$ac_component == i,]$ac_variable == "supermarkets_scaled")],
          i != "flexilbity" & 
          ac_variable == "supermarkets_scaled" ~ value * 1 / j,
          
          i == "flexilbity" & 
          ac_variable == "life_expectancy_scaled" ~ value * concentration[which(ac_variables[ac_variables$ac_component == i,]$ac_variable == "life_expectancy_scaled")],
          i != "flexilbity" & 
          ac_variable == "life_expectancy_scaled" ~ value * 1 / j,
          
          i == "flexilbity" & 
          ac_variable == "prop_labor_scaled" ~ value * concentration[which(ac_variables[ac_variables$ac_component == i,]$ac_variable == "prop_labor_scaled")],
          i != "flexilbity" & 
          ac_variable == "prop_labor_scaled" ~ value * 1 / j,
          
          # learning
          i == "learning" & 
          ac_variable == "hci_scaled" ~ value * concentration[which(ac_variables[ac_variables$ac_component == i,]$ac_variable == "hci_scaled")],
          i != "learning" & 
          ac_variable == "hci_scaled" ~ value * 1 / j
