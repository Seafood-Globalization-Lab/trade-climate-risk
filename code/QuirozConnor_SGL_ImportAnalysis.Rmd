...
consumption_sciname <- consumption_sciname %>%
  mutate(sciname_joinable_to_fishbase = str_to_title(word(sciname, 1)), 
         sciname_joinable_to_fishbase2 = word(sciname, 2), 
...
artis_fishbase_locations <- faoareas(species_list = c(unique(consumption_sciname$sciname_joinable_to_fishbase)))
