...
# New script to refer to to obtain Global Biodiversity Information Facilility (rgbif) taxa data - refer to "accepted" column to filter for target species that we will be getting higher taxa names for.
