...
for (i in levels) {
  ...
  # Shannon max/min
  shannon_max <- left_join(con_joined, con_iteration, by = "consumer_iso3c") %>% pull(shannon_custom) %>% max()
  shannon_min <- left_join(con_joined, con_iteration, by = "consumer_iso3c") %>% pull(shannon_custom) %>% min()
