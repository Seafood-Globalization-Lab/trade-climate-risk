...
scinames_excluding_tradeflows %>% filter(str_detect(sciname_hs_modified, "abramis brama"))

fb_slb_commercial_interests %>% ungroup() %>% distinct(sciname_hs_modified) %>% pull(sciname_hs_modified)
```
