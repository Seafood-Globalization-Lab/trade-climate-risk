...
> To run code: Run The first two code chunks in 01_Analysis
...
risk_map <- world_map %>%
  left_join(risk_foreign_imports, by = c("iso_a3" = "consumer_iso3c"))
