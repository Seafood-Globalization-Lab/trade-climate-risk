...
```{r supplementary (Look at adaptive capacity variable coverage) need to run 00_preprocess_data.Rmd to get these inputs}
...
## From 00_Preprocess_Data.R file

```{r}
# source("../R/get_invasives.R") # function for getting invasive species (work in progress)
